...
<head>
    <meta charset="UTF-8">
    <title>مختبر الشوقية الطبي - الفحوصات</title>
    <style>
        ...
        .service-item { background: white; padding: 30px; border-radius: 15px; border: 1px solid #eee; text-align: center; }
...
<body>
    ...
    <div class="container">
        <h1 class="page-title">مختبر الشوقية الطبي</h1>
        <div class="packages-grid">
            ...
            <div class="package-card">
                ...
                <form action="cart.php" method="POST" style="margin:0;">
					<div class="check-list">
                        <label><input type="checkbox" name="custom_tests[]" value="فحص الدم|85"> فحص دم (85)</label>
                        <label><input type="checkbox" name="custom_tests[]" value="فحص السكر|30"> فحص سكر (30)</label>
                        <label><input type="checkbox" name="custom_tests[]" value="فيتامين د|135"> فيتامين د (135)</label>
                        <label><input type="checkbox" name="custom_tests[]" value="الكوليسترول|60"> كوليسترول (60)</label>
                        <label><input type="checkbox" name="custom_tests[]" value="وظائف الكلى|75"> وظائف كلى (75)</label>
                        <label><input type="checkbox" name="custom_tests[]" value="وظائف الكبد|80"> وظائف كبد (80)</label>
                    </div>
                    
                    <input type="hidden" name="lab_name" value="مختبر الشوقية الطبي">
            ...
            <div class="package-card">
                ...
                <div class="price">380 ريال</div>
                <form action="cart.php" method="POST" style="margin:0;">
                    <input type="hidden" name="item_name" value="الباقة الفاخرة">
                    <input type="hidden" name="item_price" value="380">
                    <input type="hidden" name="lab_name" value="مختبر الشوقية الطبي">
        ...
        <div class="services-grid">
            <div class="service-item">
                <h4>فحص الدم</h4>
                <div class="price">85 ريال</div>
                <form action="cart.php" method="POST" style="margin:0;">
                    <input type="hidden" name="item_name" value="فحص الدم">
                    <input type="hidden" name="item_price" value="85">
                    <input type="hidden" name="lab_name" value="مختبر الشوقية الطبي">
